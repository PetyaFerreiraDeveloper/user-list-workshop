...
const UserList = (props) => {
  ...
  const userClickHandler = (userId, actionType) => {
  ...
  const userEditHandler = (userData, userId) => {
    ...
    <>
      <div className="table-wrapper">
        {userAction.action === UserActions.Details && (
          <UserDetails user={userAction.user} closeModal={closeModalHandler} />
        )}
        ...
        {userAction.action === UserActions.Delete && (
          <UserDelete user={userAction.user} closeModal={closeModalHandler} />
        )}
          ...
          <tbody>
            {props.users.map((user) => (
              <UserItem
                key={user._id}
                {...user}
                onActionClick={userClickHandler}
              />
            ))}
          </tbody>
        </table>
